...
export const ADD_TABLERO = 'ADD_TABLERO';
export const EDIT_TABLERO = 'EDIT_TABLERO'
export const REMOVE_TABLERO = 'REMOVE_TABLERO';
export const MANAGE_TODO_FORM = 'MANAGE_TODO_FORM';
export const SET_ACTIVE_TABLERO = 'SET_ACTIVE_TABLERO';
