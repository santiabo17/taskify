...
export const SET_TABLEROS = 'SET_CONTAINERS';
export const ADD_TABLERO = 'ADD_CONTAINER';
export const EDIT_TABLERO = 'EDIT_CONTAINER'
export const REMOVE_TABLERO = 'REMOVE_CONTAINER';
